    ...
    >
      ...
      <div className="z-10">
        ...
        <p className="text-[#ADB7BE] mb-4 max-w-md">
          {" "}
          Aqui podrá encontrar mas informacion sobre mi y mis proyectos publicos, mi bandeja de entrada esta siempre abierta.
          Siempre estaré encantado de responder a cualquier pregunta o propuesta de vuestra parte.
        </p>
          ...
          <form className="flex flex-col" onSubmit={handleSubmit}>
            <div className="mb-6">
              ...
              <input
                ...
                placeholder="ejemplo@jflorido94.es"
              />
            </div>
            <div className="mb-6">
              <label
